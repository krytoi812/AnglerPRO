document.addEventListener('DOMContentLoaded', function() {
    const guides = {
        ...
        6: {
            ...
            content: "Чтобы поделиться с нами отчетом об улове перейдите в чат с ботом,<br>выберите команду отправить отчет<br>и отправьте нам информацию о вашем улове:<br>-координаты места где вы рыбачили<br>-название водоема (если есть)<br>-как добраться до этого места<br>-сколько поймали рыбы (в кг и шт по каждому виду)<br>-фотографии<brПосле того как администрация рассмотрит ваш отчет,<br>он будет добавлен в AnglerPRO,<br> и соответственно поменяется ИР этого места.<br>Ни хвоста, ни чешуи!"
        }
    };
